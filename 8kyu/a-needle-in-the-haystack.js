...
//P: arr as parameter, random strs, inside in there one needle str
//R return a str saying where is needle in wthing the arra y the index
//Example(Input --> Output)
...
function findNeedle(haystack) {
    //loop through arr, and find the "needle"
    return `found the needle at position ${haystack.indexOf('needle')}`
    //return the index of the needle along with the str message
}
